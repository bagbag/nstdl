...
[[ "${workstation_ghostty_settings}" == *'"background-blur":[false]'* && "${workstation_ghostty_settings}" == *'"background-opacity":[0.9]'* && "${workstation_ghostty_settings}" == *'"scrollback-limit":[100000]'* && "${workstation_ghostty_settings}" == *'"unfocused-split-opacity":[0.9]'* && "${workstation_ghostty_settings}" == *'"window-vsync":[true]'* ]]
[[ "${workstation_home_packages}" == *'signal-desktop-'* ]]
[[ "${workstation_home_packages}" == *'bc-'* && "${workstation_home_packages}" == *'e2fsprogs-'* && "${workstation_home_packages}" == *'openssl-'* && "${workstation_home_packages}" == *'unzip-'* && "${workstation_home_packages}" == *'codex-'* && "${workstation_home_packages}" == *'claude-code-'* && "${workstation_home_packages}" == *'dbeaver-bin-'* && "${workstation_home_packages}" != *'ragenix-'* && "${workstation_home_packages}" != *'sysprof-'* && "${developer_home_packages}" != *'dbeaver-bin-'* ]]
