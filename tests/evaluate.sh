...
[[ "${workstation_home_packages}" == *'bc-'* && "${workstation_home_packages}" == *'e2fsprogs-'* && "${workstation_home_packages}" == *'sysprof-'* && "${workstation_home_packages}" != *'dbeaver-bin'* && "${workstation_home_packages}" != *'ragenix-'* ]]
